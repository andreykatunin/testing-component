...
4. Работай в режиме, указанном основным агентом:
   - `MODE: DISCOVERY` — не изменяй файл; верни вопросы или предложенные требования;
   - `MODE: WRITE` — обнови файл только на основании явно подтверждённого preview
     и ответов оператора.
5. Не заполняй секции формальным текстом: удали неприменимое или укажи `N/A`.
...
- При блокирующей неопределённости верни:
...
- Когда информации достаточно, верни `RESULT: READY_FOR_REVIEW` и компактный preview
  предлагаемых `BR-*`, `AC-*`, допущений и открытых вопросов.
